...
export type UncompactedMessage =
	| SystemMessage
	| Omit<UserMessage, "openaiCompaction">
	| AssistantMessage
	| ToolResultMessage;
...
export type ToolResultMessage<TDetails = JsonValue> = IsJsonCompatible<TDetails> extends true
	? {
			...
			usage?: Usage;
			/**
			 * Names from the transcript's declared tools that became available after this result.
			 * Providers without native deferred tool loading ignore this field.
			 */
